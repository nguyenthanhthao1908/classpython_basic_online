...
from datetime import datetime       #import module datetime from datetime
import pytz                         #truy cap thu vien pytz

local = datetime.now()              #tra ve ngay-gio hien tai
print("local:", local.strftime("%m/%d/%Y, %H:%M:%S"))       #in ra man hinh ngay-gio, phuong thuc str
...
print("NY:", datetime_NY.strftime("%m/%d/%Y, %H:%M:%S"))        #in ra man hinh ngay-gio, phuong thuc str
...
print("London:", datetime_London.strftime("%m/%d/%Y, %H:%M:%S"))    #in ra man hinh ngay-gio, phuong thuc str
